...
public abstract class Raster {
	...
	public void multiply(int x, int y, int ox, int oy, Image image){
		multiply(x, y, ox, oy, image, null, null);
	}
	
	public void multiply(int x, int y, int ox, int oy, Image image, List<Polygon> shadows, List<Point> casts){
		/** Multiply class */
		...
		draw(x, y, ox, oy, image, shadows, casts, new RenderClass());
	}
	
	public void lighten(int x, int y, int ox, int oy, Image image){
		lighten(x, y, ox, oy, image, null, null);
	}
	
	public void lighten(int x, int y, int ox, int oy, Image image, List<Polygon> shadows, List<Point> casts){
		/** Multiply class */
		class RenderClass extends RenderAlgorithm {
			@Override
			public int get(int pixel1, int pixel2) {
	...
	public void darken(int x, int y, int ox, int oy, Image image){
		darken(x, y, ox, oy, image, null, null);
	}
	
	public void darken(int x, int y, int ox, int oy, Image image, List<Polygon> shadows, List<Point> casts){
		/** Multiply class */
		class RenderClass extends RenderAlgorithm {
			@Override
			public int get(int pixel1, int pixel2) {
	...
	public void additive(int x, int y, int ox, int oy, Image image){
		additive(x, y, ox, oy, image, null, null);
	}
	
	public void additive(int x, int y, int ox, int oy, Image image, List<Polygon> shadows, List<Point> casts){
		/** Multiply class */
		class RenderClass extends RenderAlgorithm {
			@Override
			public int get(int pixel1, int pixel2) {
	...
	private <RenderClass extends RenderAlgorithm> void draw(int x, int y, int ox, int oy, Image image, List<Polygon> shadows, List<Point> casts, RenderClass renderClass){
		int lit_x = x;
		int lit_y = y;
		...
		try {
			...
			for (Polygon shadow : shadows){
				...
				shadow.translate(-ox, -oy);
			}
			
			for (Point cast : casts){
				cast.x -= x;
				cast.y -= y;
				cast.x -= ox;
				cast.y -= oy;
			...
			for (Polygon shadow : shadows){
				shadow.translate(lit_x + ox, lit_y + oy);
			}
	...
	public void render(int x, int y, Image image, List<Polygon> shadows, List<Point> casts) {
